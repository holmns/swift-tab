...
export const PIN_DARK_URI = `data:image/png;base64,`;
export const PIN_LIGHT_URI = `data:image/png;base64,`;
...
export function parseSearchWeights(
  value: unknown,
  fallback: SearchWeights = DEFAULT_SEARCH_WEIGHTS
): SearchWeights {
  if (!value || typeof value !== "object") return fallback;
  const input = value as Partial<Record<keyof SearchWeights, unknown>>;
  return {
    title: parseWeight(input.title, fallback.title),
    hostname: parseWeight(input.hostname, fallback.hostname),
    url: parseWeight(input.url, fallback.url),
  };
}
